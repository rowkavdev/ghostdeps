...
2. **Checkouts are inert.** Codeload tarballs only. Archive entries are validated before extraction: no path traversal, no absolute paths, no links escaping the root. Size and file-count ceilings enforced.
